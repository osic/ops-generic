...
# under the License.
#
# This tool is used to get the list of Virtual Machine on particular
# compute host  It prints the List of VMs with their owner's user ID
#
# USAGE
...
class VMsforHost(object):
    ...
    def setup_clients(self):
        """
        A method to seting up authentication and necessary
        clients for the tool - Called by Constructor
        """
        auth = Authentication()
